      ...
      >
        ...
        >
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className={`flex-shrink-0 w-full md:w-1/2 lg:w-1/3 px-4 transition-all duration-500 ${getActiveClass(
                index
              )}`}
            >
              <div className="bg-[#1a1a1a] border border-stone-500 rounded-2xl p-6 shadow-lg break-words overflow-hidden">
                <p className="text-sm leading-[1.6] font-normal text-stone-300 mb-4 break-words">
